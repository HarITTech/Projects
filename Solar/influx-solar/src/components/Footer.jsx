...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-primaryBlue to-secondaryGreen text-white pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="space-y-5">
            ...
            <p className="text-white/90 leading-relaxed">
              Leading solar energy solutions provider committed to sustainable power generation and energy independence.
            </p>
            <div className="flex space-x-5">
              <a href="#" className="text-xl hover:text-accentYellow transition-colors duration-300 hover:scale-110">
                <FaFacebook />
              </a>
              <a href="#" className="text-xl hover:text-accentYellow transition-colors duration-300 hover:scale-110">
                <FaInstagram />
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <a href="tel:9890888138" className="hover:text-accentYellow transition-colors">9890888138</a>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <FaPhone className="text-accentYellow" />
                <div>
                  ...
                  <a href="tel:8007685547" className="hover:text-accentYellow transition-colors">8007685547</a>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <FaEnvelope className="text-accentYellow" />
                <a href="mailto:info@influxsolar.com" className="hover:text-accentYellow transition-colors">
          ...
          <div>
            ...
            <div className="mt-8 bg-white/10 p-4 rounded-lg">
              ...
              <p className="text-sm mb-3 text-white/90">Subscribe for updates and offers</p>
              <div className="flex">
                <input 
                  type="email" 
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-white/80 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} Influx Solar. All rights reserved.
            </p>
            <div className="flex space-x-6">
              <Link to="/privacy-policy" className="text-sm hover:text-accentYellow transition-colors">
                Privacy Policy
              </Link>
              <Link to="/terms" className="text-sm hover:text-accentYellow transition-colors">
                Terms of Service
              </Link>
              <Link to="/sitemap" className="text-sm hover:text-accentYellow transition-colors">
                Sitemap
              </Link>
            </div>
          </div>
